  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-950 text-slate-100 antialiased">
      ...
      <footer className="border-t border-slate-900 bg-slate-950/80 py-4 text-center text-xs text-slate-500">
        <p>
          Vector Tongue &bull; Concept, Terminology & Original Prototype: <span className="text-slate-400 font-medium">RJ Marler</span> &bull; Output-Only Analysis Framework
        </p>
      </footer>
    </div>
  );
